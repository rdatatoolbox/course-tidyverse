...
knitr::include_graphics("img/paper_workflow.png")
```
...
knitr::include_graphics("img/logo_pipe.png")
```
...
knitr::include_graphics("img/piping_successive.jpg")
```
...
knitr::include_graphics("img/piping_piped.png")
```
...
```{r echo=FALSE, out.width = "85%", fig.align="center"}
knitr::include_graphics("img/dplyr_guide_for_one_table_part2.png")
```
...
knitr::include_graphics("img/ggplot2_logo.jpg")
```
...
knitr::include_graphics("img/switch_baseR_tidyverse.png")
```
...
knitr::include_graphics("img/cheatsheet_dplyr.png")
```
...
|                                   |                                                                            |
| :-------------------------------- | :------------------------------------------------------------------------- |
| `r fontawesome::fa_i("envelope")` | **olivier.gimenez@cefe.cnrs.fr**                                           |
| `r fontawesome::fa_i("home")`     | [**https://oliviergimenez.github.io/**](https://oliviergimenez.github.io/) |
| `r fontawesome::fa_i("twitter")`  | [**@oaggimenez**](https://twitter.com/oaggimenez)                          |
| `r fontawesome::fa_i("github")`   | [**@oliviergimenez**](https://github.com/oliviergimenez)                   |
